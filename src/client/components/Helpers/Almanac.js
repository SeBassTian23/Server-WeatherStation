...
export default function Almanac(props) {
  ...
  return (
    <Row>
      <Col>
        {periodToStr(props.type)} was {temperatureToStr( props.params || [], props.type)}. The humidity levels were {humidityToStr( props.params || [], props.type)} and the average air quality was {airqualityToStr( props.params || [], props.type)}.
      </Col>
    </Row>
  )
}
...
// 
const periodToStr = function(type){
  // Day
  if( type == "day")
     return `This day`;
